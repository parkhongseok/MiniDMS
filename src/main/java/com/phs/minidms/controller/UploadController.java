...
public class UploadController {
    ...
    @PostMapping("/upload")
    public String handleUpload(@ModelAttribute UploadDto uploadDto) {
        documentService.saveDocumentWithFile(uploadDto);
        return "redirect:/documents"; // 업로드 후 목록 페이지로 리다이렉트
    }
}
